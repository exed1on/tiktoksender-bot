...
import com.exed1ons.bottiktokdownloader.persistence.repository.GroupMemberRepository;
import com.exed1ons.bottiktokdownloader.persistence.repository.RoleNameRepository;
...
public class GroupMemberService {
    ...
    public void assignRoleToMember(@Nonnull final Long memberId, @Nonnull final String roleName) {
        ...
        Role role = roleNameRepository.findByName(roleName)
